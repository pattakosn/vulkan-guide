...
void VulkanEngine::init_vulkan()
{
	...
	auto inst_ret = builder.set_app_name("Gamo to spitaki tou gia Vulkan")
...
{
	//ccreate syncronization structures
	//cone fence to control when the gpu has finished rendering the frame,
	//cand 2 semaphores to syncronize rendering with swapchain
	//cwe want the fence to start signalled so we can wait on it on the first frame
